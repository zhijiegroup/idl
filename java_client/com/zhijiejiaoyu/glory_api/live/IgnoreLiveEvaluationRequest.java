...
private static final long serialVersionUID = 0L;
  ...
  public static final int ROM_ID_FIELD_NUMBER = 2;
  private long romId;
  /**
   * <code>int64 rom_id = 2;</code>
   * @return The romId.
   */
  @java.lang.Override
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + ROM_ID_FIELD_NUMBER;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.zhijiejiaoyu.glory_api.live.IgnoreLiveEvaluationRequest other) {
      ...
      if (other.getRomId() != 0L) {
        setRomId(other.getRomId());
      }
    ...
    /**
     * <code>int64 rom_id = 2;</code>
     * @param value The romId to set.
     * @return This builder for chaining.
     */
    public Builder setRomId(long value) {
