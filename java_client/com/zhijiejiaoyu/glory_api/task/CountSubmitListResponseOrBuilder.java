...
public interface CountSubmitListResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:glory_api.CountSubmitListResponse)
   ...
   * <code>repeated .glory_api.StudentSubmitCount list = 2;</code>
   */
  com.zhijiejiaoyu.glory_api.task.StudentSubmitCount getList(int index);
  /**
   * <pre>
   * 学生任务提交统计
   * </pre>
   ...
   * <code>repeated .glory_api.StudentSubmitCount list = 2;</code>
   */
  com.zhijiejiaoyu.glory_api.task.StudentSubmitCountOrBuilder getListOrBuilder(
      int index);
