...
extension GloryApi_CreateLivePlanRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 100: try { try decoder.decodeRepeatedInt64Field(value: &self.productID) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.productID.isEmpty {
      try visitor.visitPackedInt64Field(value: self.productID, fieldNumber: 100)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension GloryApi_UpdateLivePlanRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeRepeatedInt64Field(value: &self.productID) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.productID.isEmpty {
      try visitor.visitPackedInt64Field(value: self.productID, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
