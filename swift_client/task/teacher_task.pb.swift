...
struct GloryApi_DownloadTeacherTaskRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct GloryApi_DownloadTeacherTaskResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct GloryApi_CountHistoryTaskRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct GloryApi_CountHistoryTaskResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension GloryApi_DownloadTeacherTaskRequest: @unchecked Sendable {}
extension GloryApi_DownloadTeacherTaskResponse: @unchecked Sendable {}
extension GloryApi_CountHistoryTaskRequest: @unchecked Sendable {}
extension GloryApi_CountHistoryTaskResponse: @unchecked Sendable {}
...
extension GloryApi_DownloadTeacherTaskRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: GloryApi_DownloadTeacherTaskRequest, rhs: GloryApi_DownloadTeacherTaskRequest) -> Bool {
    if lhs._baseRequest != rhs._baseRequest {return false}
    if lhs.teacherTaskID != rhs.teacherTaskID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension GloryApi_DownloadTeacherTaskResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: GloryApi_DownloadTeacherTaskResponse, rhs: GloryApi_DownloadTeacherTaskResponse) -> Bool {
    if lhs._baseResp != rhs._baseResp {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension GloryApi_CountHistoryTaskRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: GloryApi_CountHistoryTaskRequest, rhs: GloryApi_CountHistoryTaskRequest) -> Bool {
    if lhs._baseRequest != rhs._baseRequest {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension GloryApi_CountHistoryTaskResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: GloryApi_CountHistoryTaskResponse, rhs: GloryApi_CountHistoryTaskResponse) -> Bool {
    if lhs._baseResp != rhs._baseResp {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
