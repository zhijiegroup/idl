...
nonisolated struct GloryApi_ListSchoolLiveTrafficResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var schoolLiveTrafficSummary: GloryApi_SchoolLiveTraffic {
    get {_storage._schoolLiveTrafficSummary ?? GloryApi_SchoolLiveTraffic()}
    set {_uniqueStorage()._schoolLiveTrafficSummary = newValue}
  }
  /// Returns true if `schoolLiveTrafficSummary` has been explicitly set.
  var hasSchoolLiveTrafficSummary: Bool {_storage._schoolLiveTrafficSummary != nil}
  /// Clears the value of `schoolLiveTrafficSummary`. Subsequent reads from it will return its default value.
  mutating func clearSchoolLiveTrafficSummary() {_uniqueStorage()._schoolLiveTrafficSummary = nil}

  var schoolLiveTrafficList: [GloryApi_SchoolLiveTraffic] {
    get {_storage._schoolLiveTrafficList}
    set {_uniqueStorage()._schoolLiveTrafficList = newValue}
  }
...
nonisolated extension GloryApi_ListSchoolLiveTrafficResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _schoolLiveTrafficSummary: GloryApi_SchoolLiveTraffic? = nil
    var _schoolLiveTrafficList: [GloryApi_SchoolLiveTraffic] = []
    ...
    init(copying source: _StorageClass) {
      ...
      _schoolLiveTrafficSummary = source._schoolLiveTrafficSummary
      _schoolLiveTrafficList = source._schoolLiveTrafficList
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._schoolLiveTrafficSummary) }()
        case 3: try { try decoder.decodeRepeatedMessageField(value: &_storage._schoolLiveTrafficList) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._schoolLiveTrafficSummary {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      } }()
      if !_storage._schoolLiveTrafficList.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._schoolLiveTrafficList, fieldNumber: 3)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: GloryApi_ListSchoolLiveTrafficResponse, rhs: GloryApi_ListSchoolLiveTrafficResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._schoolLiveTrafficSummary != rhs_storage._schoolLiveTrafficSummary {return false}
        if _storage._schoolLiveTrafficList != rhs_storage._schoolLiveTrafficList {return false}
        return true
      }
