...
加入课程 */
  ...
  GetQuickEvaluationTotalReport(
    request: live_quick_evaluate.GetQuickEvaluationTotalReportRequest
  ): Promise<live_quick_evaluate.GetQuickEvaluationTotalReportResponse>;
