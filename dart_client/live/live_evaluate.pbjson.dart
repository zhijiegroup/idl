...
final $typed_data.Uint8List evaluateRoomDescriptor = $convert.base64Decode(
    ...
    'EiUKDmV2YWx1YXRlZF90aW1lGAkgASgJUg1ldmFsdWF0ZWRUaW1l');
...
const GetEvaluateDetailResponse$json = {
  ...
  '2': [
    ...
    {'1': 'ai_result', '3': 15, '4': 3, '5': 11, '6': '.glory_api.AiResult', '10': 'aiResult'},
...
final $typed_data.Uint8List getEvaluateDetailResponseDescriptor = $convert.base64Decode(
    ...
    'VXNlchIWCgZhbmNob3IYDiABKAlSBmFuY2hvchIwCglhaV9yZXN1bHQYDyADKAsyEy5nbG9yeV'
    '9hcGkuQWlSZXN1bHRSCGFpUmVzdWx0EjEKBmRldGFpbBhkIAMoCzIZLmdsb3J5X2FwaS5FdmFs'
    'dWF0ZURldGFpbFIGZGV0YWls');
