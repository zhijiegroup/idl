...
class TeacherTask extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TeacherTask', package: const $pb.PackageName(_omitMessageNames ? '' : 'glory_api'), createEmptyInstance: create)
    ...
    ..pc<TeacherTaskParameter>(13, _omitFieldNames ? '' : 'taskParameters', $pb.PbFieldType.PM, subBuilder: TeacherTaskParameter.create)
    ..aOS(14, _omitFieldNames ? '' : 'createdAt')
    ..aOS(15, _omitFieldNames ? '' : 'updatedAt')
    ..aOM<$0.User>(16, _omitFieldNames ? '' : 'creator', subBuilder: $0.User.create)
    ..aOM<$0.User>(17, _omitFieldNames ? '' : 'updator', subBuilder: $0.User.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(13)
  $core.List<TeacherTaskParameter> get taskParameters => $_getList(12);
  ...
  @$pb.TagNumber(16)
  $0.User get creator => $_getN(15);
  @$pb.TagNumber(16)
  set creator($0.User v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasCreator() => $_has(15);
  @$pb.TagNumber(16)
  void clearCreator() => clearField(16);
  @$pb.TagNumber(16)
  $0.User ensureCreator() => $_ensure(15);

  @$pb.TagNumber(17)
  $0.User get updator => $_getN(16);
  @$pb.TagNumber(17)
  set updator($0.User v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasUpdator() => $_has(16);
  @$pb.TagNumber(17)
  void clearUpdator() => clearField(17);
  @$pb.TagNumber(17)
  $0.User ensureUpdator() => $_ensure(16);
}
